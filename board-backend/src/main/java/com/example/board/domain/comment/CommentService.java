...
public class CommentService {
    ...
    /**
     * 5. Querydsl 기반 댓글 검색 기능 추가! 🐼
     * 제목, 내용, 작성자 닉네임을 통합 검색합니다.
     */
    public List<CommentResponseDto> search(String keyword) {
        return commentRepository.searchComments(keyword).stream()
                .map(CommentResponseDto::new)
                .collect(Collectors.toList());
    }
}