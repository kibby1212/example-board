...
const BoardListPage = () => {
  ...
  const fetchBoards = async () => {
    try {
      // api.js에 baseURL을 /api로 설정했다면 경로를 단축합니다.
      const res = await api.get('/boards');
      // 백엔드가 Page 객체를 반환하므로 .content 안에 DTO 리스트가 들어있습니다.
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <div className="flex justify-between items-end mb-12 border-b-2 border-black pb-6">
        <div>
          <h1 className="text-5xl font-black tracking-tighter text-black uppercase">Board</h1>
